...
wget -qO- /usr/bin/addconfig-vmess.sh "https://raw.githubusercontent.com/GawrAme/vpnpanel-docs/refs/heads/main/modules/Marzban-MarLing/addconfig-vmess.sh" && chmod +x /usr/bin/addconfig-vmess.sh
wget -qO- /usr/bin/addconfig-vless.sh "https://raw.githubusercontent.com/GawrAme/vpnpanel-docs/refs/heads/main/modules/Marzban-MarLing/addconfig-vless.sh" && chmod +x /usr/bin/addconfig-vless.sh
wget -qO- /usr/bin/addconfig-trojan.sh "https://raw.githubusercontent.com/GawrAme/vpnpanel-docs/refs/heads/main/modules/Marzban-MarLing/addconfig-trojan.sh" && chmod +x /usr/bin/addconfig-trojan.sh
