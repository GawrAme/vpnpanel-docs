...
echo -e "HTML_CODE"
echo -e "<b>+++++ SSH-WS Account Created +++++</b>"
...
echo -e ""
echo -e "<b>Payload [INGIN MENGGUNAKAN PAYLOAD SENDIRI? HARAP JANGAN UBAH BAGIAN PATH ${WS_PATH}?u=${USERNAME}&p=${PASSWORD}</b>"
